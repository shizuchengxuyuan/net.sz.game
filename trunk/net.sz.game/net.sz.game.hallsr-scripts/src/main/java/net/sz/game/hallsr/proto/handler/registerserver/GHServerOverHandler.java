 ...
 */
public final class GHServerOverHandler extends NettyTcpHandler implements IInitBaseScript {

    private static final SzLogger log = SzLogger.getLogger();
    private static final long serialVersionUID = 1L;

    public GHServerOverHandler() {
    ...
    public void _init() {
        //把消息自动注册到消息中心
        NettyCoder.register(
                RegisterServerMessage.GHServerOverMessage.newBuilder(),/*消息体*/
    ...
    @Override
    public void run() {
        // TODO 处理RegisterServerMessage.GHServerOver消息
        RegisterServerMessage.GHServerOverMessage reqMessage = (RegisterServerMessage.GHServerOverMessage) getMessage();
